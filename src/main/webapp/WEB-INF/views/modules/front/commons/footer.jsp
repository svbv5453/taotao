...
<script type="text/javascript" src="${rootStatic}/front/js/jquery-extend.js"></script>
<script type="text/javascript" src="${rootStatic}/front/js/lib-v1.js" charset="utf-8"></script>
<script type="text/javascript" src="${rootStatic}/front/js/taotao.js" charset="utf-8"></script>
