...
<head>
    ...
    <script type="text/javascript" src="${rootStatic}/front/js/jquery-1.2.6.min.js"></script>
    <script type="text/javascript" src="${rootStatic}/front/js/login/g.base.js"></script>
   	<script type="text/javascript" src="${rootStatic}/front/js/login/jdEdit.js"></script>
...
<div class="w">
    <div id="logo">
    	<a href="http://www.taotao.com/" clstag="passport|keycount|login|01">
    		<img src="${rootStatic}/front/images/taotao-logo.gif" alt="淘淘" width="170" height="60"/>
    	</a><b></b>
   	</div>
</div>
...
<div class="w">
	<!-- links start -->
    <jsp:include page="/WEB-INF/views/modules/front/commons/footer-links.jsp" />
    <!-- links end -->
</div>
<script type="text/javascript" src="${rootStatic}/front/js/login/login.js"></script>
<script type="text/javascript" src="${rootStatic}/front/js/login/jdThickBox.js"></script>
<script type="text/javascript" src="${rootStatic}/front/js/login/checkClient.js"></script>
<script>
